...
export default function PayPeriodDetail({ period, onError }: Props) {
  ...
  return (
    <div className="p-5 bg-[#e85d04]/2">
      {period.payouts.length === 0 ? (
        <p className="text-sm text-[#1c1917]/60 text-center py-6">
      ...
      {(period.approvedAt || period.paidAt) && (
        <div className="mt-4 pt-4 border-t border-[#1c1917]/10 text-xs text-[#1c1917]/60 space-y-1">
          {period.approvedAt && (
            <p>
