...
export default function RagWashDetailView({
  ...
  const WashForm = ({ onSubmit, submitLabel }: { onSubmit: () => void; submitLabel: string }) => (
    <div className="space-y-4">
      <div>
        <label className="input-label !text-[#1c1917]/70 mb-1 block">
          Wash Date
        </label>
        <DatePicker
          value={washDate}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Card variant="cleano_light" className="p-6 h-[7rem]">
          <div className="h-full flex flex-col justify-between">
            ...
            <p className="h2-title text-[#1c1917]">{totalWashes}</p>
          </div>
        </Card>
        <Card variant="cleano_light" className="p-6 h-[7rem]">
          <div className="h-full flex flex-col justify-between">
            ...
            <p className="h2-title text-[#1c1917]">{totalRags}</p>
          </div>
        </Card>
        <Card variant="cleano_light" className="p-6 h-[7rem]">
          <div className="h-full flex flex-col justify-between">
            ...
            <p className="h2-title text-[#1c1917]">{avgRagsPerWash}</p>
          </div>
        </Card>
      </div>
        ...
        {washes.length === 0 ? (
          <Card variant="ghost" className="p-8">
            <div className="text-center">
              <div className="w-12 h-12 bg-[#e85d04]/5 rounded-2xl flex items-center justify-center mx-auto mb-3">
                <Droplets className="w-6 h-6 text-[#1c1917]/40" />
              </div>
              <p className="text-sm text-[#1c1917]/60">No wash entries yet</p>
          ...
          <div className="space-y-2">
            {washes.map((wash) => (
              <div
                key={wash.id}
                className="flex items-center justify-between p-4 rounded-xl bg-[#e85d04]/5 hover:bg-[#e85d04]/8 transition-colors">
