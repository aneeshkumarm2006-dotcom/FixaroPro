  ...
  return jobs.map((job) => {
    ...
    return {
      ...
      metadata: {
        ...
        // SOP §9.6: "Calendar should show booking status, provider, material
        // status, and D flags." Mirrors getJobsForCalendar exactly.
        ...
        customerRequestsMaterials: job.customerRequestsMaterials,
