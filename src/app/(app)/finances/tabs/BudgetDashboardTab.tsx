...
export default function BudgetDashboardTab({ transactions, budgets }: Props) {
  ...
  return (
    <Card variant="default" className="p-6">
      ...
      <div className="overflow-x-auto rounded-2xl border border-[#1c1917]/10 bg-white mb-5">
        <table className="w-full text-sm">
          ...
          <tbody>
            {rows.map((r) => (
              <tr key={r.category} className="border-t border-[#1c1917]/5">
                <td className="px-4 py-3 text-[#1c1917]/80">
                  {CATEGORY_LABELS[r.category]}
                </td>
                <td className="px-4 py-3 text-right text-[#1c1917]/80">
                ...
                <td className="px-4 py-3 w-48">
                  {r.budgeted > 0 ? (
                    <div className="flex items-center gap-2">
                      <div className="flex-1 h-2 rounded-full bg-[#e85d04]/10 overflow-hidden">
                        <div
                          className={`h-full ${
                ...
                <td className="px-4 py-3 text-right">
                  {r.id ? (
                    ...
                    <span className="text-xs text-[#1c1917]/40">—</span>
                  )}
                </td>
              </tr>
            ))}
      ...
      {chartData.length > 0 && (
        <div className="rounded-2xl border border-[#1c1917]/10 bg-white p-4">
          <h3 className="text-xs uppercase tracking-wider text-[#1c1917]/70 mb-3">
            Budget vs Actual
          </h3>
          <CBarChart
            data={chartData}
