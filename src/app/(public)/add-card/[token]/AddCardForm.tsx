    ...
    return (
      <div
        ...
        <p style={{ marginTop: 10, fontSize: 14, color: "#3a5a62", lineHeight: 1.6 }}>
          Thanks{customerName ? `, ${customerName.split(" ")[0]}` : ""}. Your card is on file and will be charged after your visit is complete.
        </p>
      </div>
    );
  }
  ...
  return (
    <div
      ...
      <p style={{ marginTop: 12, fontSize: 11, color: "#6b7d80", textAlign: "center" }}>
        Card details are processed by Stripe. Fixaro never sees your full card number.
      </p>
    </div>
  );
}
