...
export default function DatePicker({
  ...
  const NAV_BTN: React.CSSProperties = {
    ...
    background: "rgba(232,93,4,0.06)", color: "#e85d04",
  ...
  return (
    <>
      ...
      <button
        ...
        <Calendar size={14} style={{ flexShrink: 0, color: "rgba(232,93,4,0.45)" }} />
        ...
        createPortal(
          <div
            ...
            style={{
              ...
              boxShadow: "0 12px 40px rgba(232,93,4,0.14), 0 2px 8px rgba(0,0,0,0.05)",
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      aspectRatio: "1",
                      borderRadius: 8,
                      border: isT && !isS ? "1.5px solid rgba(232,93,4,0.28)" : 0,
                      fontSize: 13,
                      fontWeight: isS ? 700 : isT ? 600 : 400,
                      background: isS ? "#e85d04" : "transparent",
                      color: isS ? "#fff" : isD ? "rgba(232,93,4,0.22)" : isT ? "#e85d04" : "#1a1a1a",
