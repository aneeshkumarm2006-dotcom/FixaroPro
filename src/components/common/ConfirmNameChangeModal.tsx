        ...
        <section className="w-full bg-[#ffffff]/5 flex items-start justify-center overflow-y-auto">
          <div className="w-full max-w-[80rem] mx-auto px-6 md:px-8 py-6 md:py-8">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-[#e85d04]/5 rounded-2xl p-4 space-y-3">
                <div>
                  <p className="text-xs text-[#1c1917]/70 mb-1">Current name</p>
                  <p className="text-sm font-[400] text-[#1c1917]">{oldName}</p>
                </div>
                <div>
                  <p className="text-xs text-[#1c1917]/70 mb-1">New name</p>
                  <p className="text-sm font-[400] text-[#1c1917]">{newName}</p>
                </div>
              </div>
