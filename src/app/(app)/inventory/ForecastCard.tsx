  ...
  return (
    <Card variant="default" className="p-6">
      <div className="flex items-start justify-between mb-4">
        <div>
          <h3 className="text-sm font-[400] text-[#1c1917]">{employeeName}</h3>
        ...
        {items.map((item) => {
          ...
          return (
            <div
              ...
              <div className="flex items-center justify-between mb-2">
                <span
                  className={`text-sm font-[350] ${
                    item.needsRefill ? "text-red-700" : "text-[#1c1917]"
                  }`}>
                  {item.productName}
                </span>
                <div className="flex items-center gap-2">
              ...
              <div className="flex items-center justify-between text-xs text-[#1c1917]/50">
                <span>
