      ...
      <div className="bg-white rounded-2xl">
        <div className="text-center py-12">
          <div className="w-16 h-16 bg-[#e85d04]/5 rounded-full flex items-center justify-center mx-auto mb-3">
            <Banknote className="w-8 h-8 text-[#1c1917]/40" />
          </div>
    ...
    <div className="space-y-2">
      {entriesWithBalance.map((e) => {
        ...
        return (
          <div
            key={`${e.kind}-${e.id}`}
            className="bg-white rounded-2xl border border-[#1c1917]/10 p-5 flex items-center justify-between gap-4">
            <div className="flex items-center gap-4 min-w-0 flex-1">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="flex items-center gap-3 mt-1 text-xs text-[#1c1917]/60">
            ...
            <div className="text-right flex-shrink-0">
              ...
              <p className="text-[10px] text-[#1c1917]/50">
