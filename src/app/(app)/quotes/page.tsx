    ...
    <div className="h-full overflow-hidden overflow-y-auto p-8">
      <QuotesInboxClient
        quotes={quotes.map((q) => ({
          ...
          message: q.message,
          paintRepairArea: q.paintRepairArea,
          paintRepairSurface: q.paintRepairSurface,
          acType: q.acType,
          acLocation: q.acLocation,
          acMountType: q.acMountType,
          clientHasAcUnit: q.clientHasAcUnit,
