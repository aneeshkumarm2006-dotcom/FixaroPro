    ...
    <>
      ...
      <button
        ...
        style={{
          ...
          fontSize: FS[size],
          color: selected ? "#111" : "rgba(232,93,4,0.38)",
          fontFamily: "inherit",
        ...
        createPortal(
          <div
            ...
            style={{
              ...
              boxShadow:
                "0 8px 32px rgba(232,93,4,0.13), 0 2px 8px rgba(0,0,0,0.05)",
              overflow: "hidden",
                    ...
                    <button
                      ...
                      onMouseLeave={e => {
                        (e.currentTarget as HTMLButtonElement).style.background =
                          active ? "rgba(232,93,4,0.08)" : "transparent";
                      }}>
                      <span>{opt.label}</span>
                      {active && (
                        <Check
                          size={13}
                          style={{ color: "#e85d04", flexShrink: 0 }}
                        />
                      )}
                    </button>
                  );
