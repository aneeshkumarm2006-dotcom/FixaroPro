...
export default function IncomeStatementTab({ transactions }: Props) {
  ...
  const selectCls =
    "px-4 py-2 rounded-xl border border-transparent bg-[#e85d04]/5 text-sm text-[#1c1917] focus:outline-none focus:ring-2 focus:ring-[#e85d04]/20";
  ...
  return (
    <Card variant="default" className="p-6">
      <div className="flex items-start justify-between gap-4 mb-5">
        <div className="flex items-start gap-2">
          <div className="p-2 bg-[#e85d04]/10 rounded-lg">
            <FileBarChart className="w-4 h-4 text-[#1c1917]" />
          </div>
          <div>
      ...
      <div className="rounded-2xl border border-[#1c1917]/10 bg-white overflow-hidden">
        <table className="w-full text-sm">
          <tbody>
            <tr className="bg-[#e85d04]/5">
              <td className="px-5 py-3 text-xs uppercase tracking-wider text-[#1c1917]/70 font-[500]">
                Revenue
              </td>
              <td className="px-5 py-3"></td>
            </tr>
            <tr className="border-t border-[#1c1917]/5">
              <td className="px-5 py-3 text-[#1c1917]/80 pl-8">Total Revenue</td>
              <td className="px-5 py-3 text-right text-[#1c1917] font-[500]">
                {formatCurrency(revenueTotal)}
              </td>
            </tr>
            <tr className="bg-[#e85d04]/5 border-t border-[#1c1917]/10">
              <td className="px-5 py-3 text-xs uppercase tracking-wider text-[#1c1917]/70 font-[500]">
                Expenses
              </td>
              <td className="px-5 py-3"></td>
            ...
            {EXPENSE_CATEGORIES.map((c) => (
              <tr key={c} className="border-t border-[#1c1917]/5">
                <td className="px-5 py-3 text-[#1c1917]/80 pl-8">
                  {CATEGORY_LABELS[c]}
                </td>
                <td className="px-5 py-3 text-right text-[#1c1917]/80">
                  {formatCurrency(expenseByCategory[c])}
                </td>
              </tr>
            ))}
            <tr className="border-t border-[#1c1917]/10 bg-[#e85d04]/5">
              <td className="px-5 py-3 text-[#1c1917] font-[500]">
                Total Expenses
              </td>
              <td className="px-5 py-3 text-right text-[#1c1917] font-[500]">
            ...
            <tr className="border-t border-[#1c1917]/15">
              <td className="px-5 py-4 text-[#1c1917] font-[500] text-base">
                Net Income
              </td>
              <td
      ...
      {rows.length > 1 && (
        <div className="mt-5">
          <h3 className="text-xs uppercase tracking-wider text-[#1c1917]/70 mb-2">
            Monthly Breakdown
          </h3>
          <div className="rounded-2xl border border-[#1c1917]/10 bg-white overflow-hidden">
            <table className="w-full text-sm">
              <thead className="bg-[#e85d04]/5 text-[#1c1917]/70 text-[10px] uppercase tracking-wider">
                <tr>
              ...
              <tbody>
                {rows.map((r) => {
                  ...
                  return (
                    <tr key={r.month} className="border-t border-[#1c1917]/5">
                      <td className="px-5 py-3 text-[#1c1917]/80">{r.month}</td>
                      <td className="px-5 py-3 text-right text-[#1c1917]/80">
