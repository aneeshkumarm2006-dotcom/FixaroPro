...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variantClasses = {
      default:
        "bg-[#e85d04]/3 text-[#1c1917] hover:bg-[#e85d04]/10 border-[#1c1917]/3",
      light:
        "bg-[#e85d04]/2 text-[#1c1917] hover:bg-[#e85d04]/4 border-[#1c1917]/2",
      selected:
        "bg-[#59B8BC]/15 text-[#1c1917] hover:bg-[#59B8BC]/20 border-[#59B8BC]/5",
      secondary: "bg-gray-100 text-gray-700 hover:bg-gray-200",
      ghost:
        "bg-transparent text-[#1c1917] hover:bg-[#e85d04]/2 border-transparent",
      outline:
        "border-[#1c1917]/10 hover:border-[#1c1917]/20 focus:border-[#77C8CC] text-[#1c1917]",
      ...
      primary:
        "bg-[#D7F0F1] text-[#1c1917] hover:bg-[#D7F0F1]/80  border-[#D7F0F1]/5",
      cleano:
      ...
      cancel:
        "text-[#1c1917]/80 bg-white hover:bg-gray-50 border-gray-200 backdrop-blur-[3px]",
      action:
        "text-white bg-[#e85d04]/90 hover:bg-[#e85d04] backdrop-blur-[3px] border-transparent",
