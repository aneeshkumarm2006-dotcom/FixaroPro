    ...
    <div className="space-y-4">
      ...
      <div
        ...
        <div className="flex flex-col items-center gap-2">
          <div className="p-3 rounded-full bg-[#e85d04]/10">
            <ImagePlus className="w-6 h-6 text-[#1c1917]" />
          </div>
              ...
              <div
                ...
                <div className="p-3 space-y-2">
                  <input
                    ...
                    className="w-full text-sm rounded-lg border border-neutral-950/10 px-2 py-1.5 focus:outline-none focus:border-[#1c1917]/40"
                  />
                  <div className="flex items-center justify-between text-xs">
                    ...
                    <span className="text-neutral-950/50">
                      ...
                      {p.compressed && (
                        <span className="ml-1 text-[#1c1917]/70">
