        ...
        <div className="space-y-4 max-h-[70vh] overflow-y-auto pr-1">
          ...
          <div>
            ...
            {draft.items.length === 0 && (
              <p className="text-xs text-[#1c1917]/60">No items added.</p>
            )}
            <div className="space-y-2">
              {draft.items.map((item, idx) => (
                <div
                  key={idx}
                  className="p-3 rounded-xl bg-[#e85d04]/5 space-y-2">
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1 space-y-2">
                      ...
                      />
                      <label className="flex items-center gap-2 text-xs text-[#1c1917] select-none">
                        <input
                          type="checkbox"
