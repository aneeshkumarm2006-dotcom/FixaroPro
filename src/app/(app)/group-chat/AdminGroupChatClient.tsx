...
export default function AdminGroupChatClient({
  ...
  // Active Pros — candidates for the create picker and member editor.
  const { data: candidates } = useSWR(
    creating || membersOpen ? "chat-pro-candidates" : null,
    async () => {
      const res = await listProsForChannel();
      if (!res.success) throw new Error(res.error);
      return res.data;
    }
  );
  ...
  async function handleDelete(messageId: string) {
    if (!confirm("Delete this message? Pros will no longer see it.")) return;
    setError(null);
    // Optimistic removal
        ...
        <div style={{ position: "relative" }}>
          <button
            ...
            style={{
              ...
              cursor: "pointer",
              background: settingsOpen ? "var(--accent)" : "#fff",
                ...
                [
                  {
                    ...
                    label: "Pro-to-Pro DMs",
                    hint: "Pros can start private 1:1 chats.",
                  },
                  {
                    key: "showContactInfo" as const,
                    label: "Show contact info",
                    hint: "Phone/email visible in the Pro directory.",
                  },
                ]
              ).map((s) => {
                ...
                return (
                  <label
                    ...
                    style={{
                      ...
                      gap: 10,
                      cursor: chatSettings ? "pointer" : "default",
                    }}>
                    <button
                      ...
                      style={{
                        ...
                        marginTop: 2,
                        position: "relative",
                        background: on ? "var(--accent)" : "rgba(232,93,4,0.18)",
      ...
      <div
        ...
        <div
                ...
                {(c.isDefault || c.isDirect) && (
                  <span
                    style={{
                      ...
                      padding: "2px 6px",
                      borderRadius: 999,
                      background: active ? "rgba(255,255,255,0.2)" : "rgba(232,93,4,0.1)",
          ...
          {creating ? (
            <div style={{ padding: "8px 4px", display: "flex", flexDirection: "column", gap: 8 }}>
              ...
              />
              {/* Member picker — Pros who can see this channel */}
              <div
                style={{
                  border: "1px solid rgba(232,93,4,0.15)",
                  borderRadius: 8,
        ...
        <div
            ...
            {isCustomChannel && (
              <button
                ...
                style={{
                  ...
                  border: "1px solid rgba(232,93,4,0.2)",
                  cursor: "pointer",
                  background: membersOpen ? "var(--accent)" : "#fff",
          ...
          {membersOpen && isCustomChannel && (
            <div
              style={{
                borderBottom: "1px solid rgba(232,93,4,0.10)",
                padding: "12px 24px",
                display: "flex",
                flexDirection: "column",
                gap: 10,
