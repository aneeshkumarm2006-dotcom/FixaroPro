            ...
            <table className="w-full">
              <thead>
                <tr className="bg-[#e85d04]/5">
                  <th className="p-4 text-left text-xs font-[350] text-[#1c1917]/40 uppercase tracking-wide min-w-[180px]">
                    Product
                  </th>
                  <th className="p-4 text-left text-xs font-[350] text-[#1c1917]/40 uppercase tracking-wide min-w-[100px]">
                    Current Cost
                  </th>
                  {suppliers.map((s) => (
                    <th
                      key={s.id}
                      className="p-4 text-left text-xs font-[350] text-[#1c1917]/40 uppercase tracking-wide min-w-[120px]">
                      {s.name}
                    </th>
                  ))}
                  <th className="p-4 text-left text-xs font-[350] text-[#1c1917]/40 uppercase tracking-wide min-w-[120px]">
                    Best Price
                  </th>
                  <th className="p-4 text-left text-xs font-[350] text-[#1c1917]/40 uppercase tracking-wide min-w-[100px]">
                    Savings
              ...
              <tbody className="divide-y divide-[#e85d04]/4">
                {productsWithMultiplePrices.map((product) => {
                  ...
                  return (
                    <tr
                      ...
                      className="hover:bg-[#e85d04]/1 transition-colors">
                      <td className="p-4">
                      ...
                      <td className="p-4">
                        {cheapest ? (
                          ...
                          <span className="text-sm text-[#1c1917]/30">-</span>
                        )}
                      </td>
                      <td className="p-4">
                        {savings > 0 ? (
                      ...
                      <div
                        ...
                        <span
                          className={`text-xs font-[400] ${
                            isCheapest ? "text-green-600" : "text-[#1c1917]"
                          }`}>
                          ${p.price.toFixed(2)}
                        </span>
                      </div>
