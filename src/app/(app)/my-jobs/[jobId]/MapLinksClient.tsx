...
export default function MapLinks({ address }: { address: string }) {
  ...
  const base: React.CSSProperties = {
    ...
    textDecoration: "none", border: "1px solid var(--primary-20, rgba(196,76,3,0.2))",
    color: "var(--primary, #c44c03)", background: "var(--primary-5, rgba(196,76,3,0.05))",
    whiteSpace: "nowrap",
  };
  ...
  return (
    <div style={{ display: "flex", gap: 6, flexWrap: "wrap", marginTop: 8, marginBottom: 4 }}>
      ...
      <button
        ...
        style={{
          ...base, cursor: "pointer",
          background: copied ? "rgba(5,150,105,0.1)" : "var(--primary-5, rgba(196,76,3,0.05))",
          borderColor: copied ? "rgba(5,150,105,0.3)" : "var(--primary-20, rgba(196,76,3,0.2))",
          color: copied ? "#059669" : "var(--primary, #c44c03)",
        }}
      >
