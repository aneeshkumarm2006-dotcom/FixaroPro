...
const PRODUCT_CATEGORIES = ["LIQUID_SPRAY", "MOP_LIQUID", "DISPOSABLE", "TOOL", "OTHER"] as const;
...
export const CSV_ENTITIES: Record<EntityKey, CsvEntityConfig> = {
  clients: {
    ...
    // "Id" / "First Name" / "Last Name" don't map to Fixaro's single `name`
    // column, so they're ignored rather than flagged as unknown.
    ...
    columns: [
      ...
      { key: "zip", type: "string", example: "M5V 1A1", aliases: ["Zip/Postal Code", "Postal Code", "Zip Code", "Zip", "Postal"] },
