...
function buildHtml(opts: {
  ...
  <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;background:#f7f5f0;padding:32px 16px;color:#003C46">
    <div style="max-width:520px;margin:0 auto;background:#fff;border-radius:16px;padding:28px 24px;box-shadow:0 2px 14px rgba(0,0,0,0.05)">
      <p style="font-size:13px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#005F6A;opacity:0.7;margin:0 0 8px">New message</p>
      ...
      <blockquote style="margin:14px 0 18px;padding:14px 16px;background:#f4f8f9;border-left:3px solid #005F6A;border-radius:6px;color:#003C46;font-size:14.5px;line-height:1.5;white-space:pre-wrap">${safeBody}</blockquote>
      <a href="${opts.ctaHref}" style="display:inline-block;padding:11px 22px;background:#005F6A;color:#fff;border-radius:10px;text-decoration:none;font-size:14px;font-weight:600">${opts.ctaLabel}</a>
