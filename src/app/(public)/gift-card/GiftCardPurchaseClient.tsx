  ...
  if (clientSecret && giftCardId) {
    return (
      <div
        ...
        <h2 style={{ margin: 0, fontSize: 20, fontWeight: 700, color: "#e85d04" }}>
    ...
    <div
          ...
          {tiers.map((t) => (
            <button
              ...
              style={{
                ...
                fontSize: 18,
                fontWeight: 700,
                background: amount === t ? "#e85d04" : "#fff",
                color: amount === t ? "#fff" : "#0a1f24",
                border: amount === t ? "2px solid #e85d04" : "1px solid rgba(232,93,4,0.18)",
                borderRadius: 10,
                cursor: "pointer",
      ...
      <button
        ...
        style={{
          ...
          fontWeight: 700,
          color: "#fff",
          background: canSubmit ? "#e85d04" : "#7daab0",
          border: "none",
          borderRadius: 10,
