    ...
    <Card variant="default" className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
        <div className="rounded-xl bg-[#e85d04]/5 p-4">
          ...
          {taxConfig.gstNumber && (
            <div className="text-[11px] text-[#1c1917]/60 mt-1">
              {taxConfig.gstNumber}
            </div>
          )}
        </div>
      ...
      <div className="rounded-2xl border border-[#1c1917]/10 bg-white overflow-hidden">
        <table className="w-full text-sm">
          <tbody>
            <tr>
              <td className="px-5 py-3 text-[#1c1917]/80">Revenue</td>
              <td className="px-5 py-3 text-right text-[#1c1917]">
                {formatCurrency(revenueTotal)}
              </td>
            </tr>
            <tr className="border-t border-[#1c1917]/5">
              <td className="px-5 py-3 text-[#1c1917]/80">Expenses</td>
              <td className="px-5 py-3 text-right text-[#1c1917]">
                {formatCurrency(expenseTotal)}
              </td>
            </tr>
            <tr className="border-t border-[#1c1917]/5">
              <td className="px-5 py-3 text-[#1c1917]/80">
            ...
            <tr className="border-t border-[#1c1917]/10 bg-[#e85d04]/5">
              <td className="px-5 py-4 text-[#1c1917] font-[500]">
                Net Remittance Owed
              </td>
              <td
                className={`px-5 py-4 text-right text-base font-[500] ${
                  netRemittance >= 0 ? "text-[#1c1917]" : "text-green-700"
                }`}>
                {formatCurrency(netRemittance)}
              </td>
            </tr>
            <tr className="border-t border-[#1c1917]/5">
              <td className="px-5 py-3 text-[#1c1917]/60 text-xs">
                Estimated if full GST+QST on revenue ({combinedRate.toFixed(3)}%)
              </td>
              <td className="px-5 py-3 text-right text-[#1c1917]/60 text-xs">
