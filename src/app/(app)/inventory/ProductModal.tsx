            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div>
                ...
                <select
                  {...register("category")}
                  disabled={disableForm}
                  className="w-full px-4 py-3 rounded-xl border border-[#1c1917]/15 bg-white text-[#003C46] text-sm focus:outline-none focus:border-[#1c1917] focus:ring-2 focus:ring-[#e85d04]/10">
