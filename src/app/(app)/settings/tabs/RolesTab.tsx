        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="text-left border-b border-[#1c1917]/10">
              ...
              <th className="py-3 pr-3 text-xs font-[350] text-[#1c1917]/70 uppercase tracking-wide text-center">
                Owner
              </th>
              <th className="py-3 pr-3 text-xs font-[350] text-[#1c1917]/70 uppercase tracking-wide text-center">
                Admin
              </th>
              <th className="py-3 text-xs font-[350] text-[#1c1917]/70 uppercase tracking-wide text-center">
                Employee
              </th>
            </tr>
          </thead>
...
function PermIcon({ allowed }: { allowed: boolean }) {
  return allowed ? (
    <Check className="w-4 h-4 text-[#1c1917] inline-block" />
  ) : (
    <X className="w-4 h-4 text-[#1c1917]/20 inline-block" />
  );
}
