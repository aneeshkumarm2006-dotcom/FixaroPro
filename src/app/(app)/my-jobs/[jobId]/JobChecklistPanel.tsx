      ...
      <div className="space-y-3">
        ...
        {canEdit && (
          <button
            ...
            disabled={generating}
            className="inline-flex items-center gap-2 px-4 py-2 rounded-2xl text-sm bg-[#e85d04] text-white hover:bg-[#e85d04]/90 transition-colors disabled:opacity-50">
            {generating ? (
                  ...
                  <div className="flex items-start gap-3">
                    <button
                      ...
                      className={`mt-0.5 flex-shrink-0 w-6 h-6 rounded-md flex items-center justify-center border transition-colors disabled:opacity-50 ${
                        isCompleted
                          ? "bg-[#e85d04] border-[#1c1917] text-white"
                          : "border-neutral-300 text-transparent hover:border-[#1c1917]/50"
                      }`}
                      aria-label={
                      ...
                      {isEditingNotes ? (
                        <div className="mt-2 space-y-2">
                          <textarea
                            ...
                            className="w-full px-3 py-2 rounded-lg border border-neutral-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#e85d04]/20"
                          />
                          <div className="flex justify-end gap-2">
                            ...
                            <button
                              ...
                              disabled={isPending}
                              className="px-3 py-1 rounded-lg text-xs bg-[#e85d04] text-white hover:bg-[#e85d04]/90 disabled:opacity-50">
                              Save Note
                            </button>
                          </div>
                        </div>
