...
export default function ProductDetailView({
  ...
  const OverviewTab = () => (
    <div className="space-y-6">
      ...
      <div className="w-1/2 grid grid-cols-1 gap-12">
        <Card variant="ghost" className="!p-0">
          <div className="flex items-center gap-2 mb-4">
            <div className="p-2 bg-[#e85d04]/10 rounded-lg">
              <Archive className="w-4 h-4 text-[#1c1917]" />
            </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex justify-between items-center p-3 rounded-xl bg-[#e85d04]/2">
              <span className="input-label !text-[#1c1917]/70">
                Warehouse Stock
              </span>
            ...
            <div className="flex justify-between items-center p-3 rounded-xl bg-[#e85d04]/5">
              <span className="input-label !text-[#1c1917]/70">Status</span>
              {isLowStock ? (
        ...
        <Card variant="ghost" className="!p-0">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="input-label !text-[#1c1917]/70">Pricing</h3>
          </div>
      ...
      {product.description && (
        <>
          <h2 className="input-label !text-[#1c1917]/70">Description</h2>
          <Card variant="cleano_light" className="p-6">
            <p className="text-sm text-[#1c1917]/80 whitespace-pre-wrap leading-relaxed">
              {product.description}
            </p>
          </Card>
        </>
    ...
    <div className="space-y-6">
      {employeeAssignments.length === 0 ? (
        <Card variant="ghost" className="p-8">
          <div className="text-center">
            <div className="w-12 h-12 bg-[#e85d04]/5 rounded-2xl flex items-center justify-center mx-auto mb-3">
              <Users className="w-6 h-6 text-[#1c1917]/40" />
            </div>
              ...
              <div className="min-w-max">
                ...
                <div className="divide-y divide-[#e85d04]/4">
                  {paginatedAssignments.length === 0 ? (
                    <div className="p-8 text-center text-sm font-[350] text-[#1c1917]/70">
                    ...
                    paginatedAssignments.map((assignment) => (
                      <div
                        ...
                        <div className="w-[200px] p-4">
                          <p className="app-title-small !text-[#1c1917]/40 truncate">
                            {assignment.notes || "-"}
                          </p>
                        </div>
                        <div className="w-[120px] p-4">
                ...
                {/* Footer Totals */}
                {paginatedAssignments.length > 0 && (
                  <div className="flex bg-[#e85d04]/5 border-t border-[#1c1917]/10">
                    <div className="w-[200px] p-4">
      ...
      <div className="relative z-10 max-w-[80rem] w-full mx-auto space-y-6">
        ...
        <div className="w-full flex flex-col md:flex-row items-start justify-between gap-4 my-10">
          ...
          <div className="text-right">
            <p className="text-sm text-[#1c1917]/60 !mb-2">Cost per unit</p>
            <p className="text-xl font-[350] text-[#1c1917]">
              ${product.costPerUnit.toFixed(2)} / {product.unit}
            </p>
          </div>
        </div>
