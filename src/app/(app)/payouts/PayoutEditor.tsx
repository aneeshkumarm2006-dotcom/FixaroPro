      ...
      <div className="bg-white rounded-xl p-4 flex items-center justify-between gap-4">
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2 flex-wrap">
            <span className="text-sm font-[400] text-[#1c1917] truncate">
              {payout.employeeName}
            </span>
          ...
          {payout.notes && (
            <p className="text-xs text-[#1c1917]/50 mt-1 italic">
              {payout.notes}
            </p>
          )}
        </div>
        <div className="flex items-center gap-3 flex-shrink-0">
          <span className="text-lg font-[500] text-[#1c1917]">
    ...
    <div className="bg-white rounded-xl p-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {[
          ...
          <div key={f.label}>
            <label className="text-[10px] uppercase tracking-wider text-[#1c1917]/50 font-[400]">
              {f.label}
            </label>
            <input
              type="number"
              ...
              disabled={saving}
              className="w-full px-3 py-2 rounded-xl bg-[#e85d04]/5 text-sm text-[#1c1917] focus:outline-none"
            />
          </div>
        ))}
      </div>
      <div className="mt-3">
        ...
        <input
          ...
          className="w-full px-3 py-2 rounded-xl bg-[#e85d04]/5 text-sm text-[#1c1917] focus:outline-none placeholder:text-[#1c1917]/40"
        />
      </div>
      <div className="flex items-center justify-between mt-4 pt-3 border-t border-[#1c1917]/10">
