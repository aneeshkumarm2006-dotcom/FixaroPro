  ...
  return (
    <div className="space-y-4">
      <SectionCard
        ...
        {sorted.length === 0 ? (
          <div className="text-sm text-[#1c1917]/60 py-8 text-center">
            No service areas yet. Add postal prefixes you cover (e.g. H1, H2,
            H3 for Montreal) to enable public bookings.
          </div>
        ) : (
          <div className="rounded-2xl bg-[#e85d04]/5 overflow-hidden">
            <table className="w-full text-sm">
              <thead>
                <tr className="text-left text-[10px] uppercase tracking-wide text-[#1c1917]/60">
              ...
              <tbody className="divide-y divide-[#e85d04]/10">
                {sorted.map((area) => (
                  <tr key={area.id} className="text-[#1c1917]">
