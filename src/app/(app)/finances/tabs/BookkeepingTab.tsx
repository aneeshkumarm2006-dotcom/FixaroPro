  ...
  return (
    <Card variant="default" className="p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-5">
        <div className="rounded-xl bg-[#e85d04]/5 p-4">
          <div className="text-xs uppercase tracking-wide text-[#1c1917]/60">
            Revenue
          </div>
          <div className="text-xl font-[400] text-[#1c1917] mt-1">
        ...
        <div className="rounded-xl bg-[#e85d04]/5 p-4">
          ...
          <div
            className={`text-xl font-[400] mt-1 ${
              totals.net >= 0 ? "text-[#1c1917]" : "text-red-600"
            }`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-3 mb-4">
        <div className="relative">
          <Search className="w-4 h-4 text-[#1c1917]/40 absolute left-3 top-1/2 -translate-y-1/2" />
          <input
            type="text"
            placeholder="Search"
            value={search}
      ...
      {showForm && (
        <div className="mb-5 rounded-2xl border border-[#1c1917]/10 bg-white p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="text-[#1c1917]/60 hover:text-[#1c1917]">
              <X className="w-4 h-4" />
            </button>
          </div>
          <form onSubmit={handleSave} className="grid grid-cols-2 gap-4">
            <div>
              <label className="text-xs text-[#1c1917]/70 uppercase tracking-wide mb-1 block">
                Date
              </label>
              <DatePicker
                value={form.date}
      ...
      <div className="overflow-x-auto rounded-2xl border border-[#1c1917]/10 bg-white">
        <table className="w-full text-sm">
          <thead className="bg-[#e85d04]/5 text-[#1c1917]/70 uppercase text-[10px] tracking-wider">
            <tr>
          ...
          <tbody>
            {paged.length === 0 ? (
              <tr>
                <td
                  colSpan={7}
                  className="text-center py-8 text-[#1c1917]/50 text-sm">
              ...
              paged.map((t) => (
                <tr
                  key={t.id}
                  className="border-t border-[#1c1917]/5 hover:bg-[#e85d04]/3">
                  <td className="px-4 py-3 text-[#1c1917]/80 whitespace-nowrap">
                    ...
                    <span
                      className={`text-[10px] px-2 py-0.5 rounded-full uppercase tracking-wider font-[500] ${
                        t.category === "REVENUE"
                          ...
                          : "bg-[#e85d04]/10 text-[#1c1917]"
                      }`}>
                      {CATEGORY_LABELS[t.category]}
                    </span>
                  </td>
                  <td className="px-4 py-3 text-[#1c1917]/80">
                    <div className="flex items-center gap-2">
                      {t.isAuto && (
                        <Zap
                          className="w-3 h-3 text-[#1c1917]/50"
                          strokeWidth={2}
                        />
                      )}
                      {t.description || "—"}
                  ...
                  <td className="px-4 py-3 text-right text-[#1c1917]/70">
                  ...
                  <td className="px-4 py-3 text-right">
                    <div className="inline-flex gap-1">
                      <button
                        onClick={() => openEdit(t)}
                        className="p-1.5 rounded-lg hover:bg-[#e85d04]/10 text-[#1c1917]/70"
                        title="Edit">
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-between mt-4 text-xs text-[#1c1917]/70">
          <div>
          ...
          <div className="flex gap-1">
            <button
              ...
              className="p-1.5 rounded-lg hover:bg-[#e85d04]/10 disabled:opacity-40">
